                                                                ...
                                                                {completed &&
                                                                    completed.map((item, i) => (
                                                                        <tr key={i}>
                                                                            ...
                                                                            <td>
                                                                                <h6 className="">
                                                                                    {item.trackingorder[0].providercommission}
                                                                            ...
                                                                            <td>
                                                                                <p>
                                                                                    <span className="fs-5">
                                                                                        {item.trackingorder[0].payment === true ? <span><i class="bi-check-circle-fill ms-4 fs-2 text-success"></i></span> : <span className="text-danger fw-bold">PayMent Panding</span>}
                                                                                    </span>
                                                                                </p>
                                                                            </td>
